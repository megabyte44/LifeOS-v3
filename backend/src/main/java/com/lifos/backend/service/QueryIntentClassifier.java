...
public class QueryIntentClassifier {
    ...
    private static final Map<Intent, Set<String>> INTENT_KEYWORDS = Map.of(
            ...
            Intent.GOALS,    Set.of("goal", "target", "milestone", "progress", "achieve", "objective"),
            Intent.GYM,      Set.of("gym", "workout", "exercise", "protein", "lift", "muscle", "training", "creatine", "fitness"),
            Intent.FINANCE,  Set.of("spend", "money", "budget", "expense", "income", "transaction", "cost", "financial", "saving"),
